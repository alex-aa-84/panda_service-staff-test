...
import wwf.org.stafftest.service.PermissionSubmoduleService;
...
public class PermissionSubmoduleController {
    ...
    public ResponseEntity<PermissionSubmodule> createData(@Valid @RequestBody PermissionSubmodule data, BindingResult result){
        ...
        PermissionSubmodule dataBD = service.findByPermissionModuleAndSubmoduleAndRoute(data.getPermissionModule(), data.getSubmodule(), data.getRoute());
