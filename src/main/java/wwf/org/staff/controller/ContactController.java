...
import wwf.org.staff.service.ContactService;
...
public class ContactController {
    ...
    public ResponseEntity<List<Contact>> getDataUser(@PathVariable("id") Long id){
        List<Contact> data = service.findByUserId(id);
        if(null == data){
