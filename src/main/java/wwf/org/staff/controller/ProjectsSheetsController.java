...
public class ProjectsSheetsController {
    ...
    public ResponseEntity<ProjectsSheets> createData(@Valid @RequestBody ProjectsSheets data, BindingResult result){
        ...
        ProjectsSheets dataBD = service.findByFiscalYearAndMonthFiscalYearAndUserIdAndProjectsId(data.getFiscalYear(), data.getMonthFiscalYear(), data.getUserId(), data.getProjects());
